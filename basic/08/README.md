...
#### 04. Otherwise, return the sum of two recursive calls: `fibonacci(n - 1) + fibonacci(n - 2)`.
#### 05. Use a loop & echo statements to display Fibonacci numbers for the desired range.
